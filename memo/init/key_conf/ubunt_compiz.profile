...
[core]
s0_active_plugins = core;composite;opengl;regex;copytex;compiztoolbox;snap;commands;vpswitch;wall;move;place;put;imgpng;resize;session;grid;unitymtgrabhandles;mousepoll;animation;expo;workarounds;fade;ezoom;scale;unityshell;
s0_outputs = 2560x1440+0+0;1920x1080+2560+0;
s0_autoraise = false
...
s0_put_left_key = <Alt>Left
s0_put_right_key = <Alt>Right
s0_put_top_key = <Alt>Up
s0_put_bottom_key = <Alt>Down
s0_put_topleft_key = <Alt><Super>Left
s0_put_topright_key = <Shift><Super>Right
