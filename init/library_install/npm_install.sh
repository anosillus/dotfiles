...
sudo npm install -g textlint-rule-ja-hiragana-hojodoushi textlint-rule-max-number-of-lines textlint-rule-no-hoso-kinshi-yogo
textlint-rule-no-start-duplicated-conjunction textlint-rule-period-in-list-item textlint-rule-prefer-tari-tari textlint-rule-preset-ja-technical-writing textlint-rule-preset-jtf-style textlint-rule-spellcheck-tech-word
...
# @textlint-ja/textlint-rule-no-kana-english-v @textlint-ja/textlint-rule-kana-english-suffix-y @textlint-ja/textlint-rule-kana-english-suffix-ware @textlint-ja/textlint-rule-kana-english-suffix-re @textlint-ja/textlint-rule-kana-english-suffix-er @textlint-ja/textlint-rule-kana-english-fo-pho
