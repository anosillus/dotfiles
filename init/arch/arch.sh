...
yay -S anyenv cabocha crfpp direnv genymotion gitkraken gnome-shell-pomodoro google-chrome gyazo ibus-qt mecab mecab-ipadic mecab-ipadic-neologd-git openrazer-daemon openrazer-driver-dkms openrazer-meta peco pepper-flash python-openrazer qt4 razercommander ripgrep-all vivaldi-update-ffmpeg-hook waffle xmind-2020 ytop-bin fish tmux tokei-bin fd procs exa rig-grep bat ufw gufw clamav clamtk mpd wget
...
yay -S ttf-fantasque-sans-mono nerd-fonts-iosevka nerd-fonts-iosevka
